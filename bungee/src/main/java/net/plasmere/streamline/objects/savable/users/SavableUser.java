...
//    public String latestServer;
    ...
    public String findServer() {
        if (this.uuid.equals("%")) {
            ...
            try {
                ...
                if (player.getServer().getInfo() != null) return ConfigUtils.consoleServer();
    ...
    public SavableUser(CommandSender sender, SavableAdapter.Type type) {
        this((sender instanceof ProxyServer) ? "%" : ((ProxiedPlayer) sender).getUniqueId().toString(), type);
    }
