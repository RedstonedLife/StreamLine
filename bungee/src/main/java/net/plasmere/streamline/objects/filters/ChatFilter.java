...
public class ChatFilter {
    ...
    public SingleSet<Boolean, String> applyFilter(String toFilter, CommandSender involved) {
        ...
        if (isDifferent) {
            ...
            if (script != null) script.execute(StreamLine.getInstance().getProxy().getConsole(), PlayerUtils.getOrGetSavableUser(involved));
        }

        return new SingleSet<>(this.blocked && isDifferent, toReturn);
    }

    public boolean checkBypasses(CommandSender checkOn) {
